            ...
            <div className="bg-blue-800/10 border border-blue-800/30 rounded-2xl p-8 space-y-6 mt-2">
              ...
              <div className="pt-4 border-t border-blue-800/20 space-y-2">
                <p className="text-sm text-muted-foreground leading-relaxed">
                  ...
                  is designed to evolve into that future. Your systems won't
                  break when complexity increases.
                </p>
              </div>
            </div>
          </div>
      ...
      >
        <div className="mx-auto max-w-7xl px-6 space-y-12">
          ...
          <div className="grid md:grid-cols-2 gap-12">
            <div className="space-y-6">
              <p className="text-lg text-muted-foreground leading-relaxed">
                By building workflows with future compute models in mind, we
                avoid rebuilding from scratch later.
              </p>
              <p className="text-lg text-muted-foreground leading-relaxed">
                This allows our clients to grow into more autonomous operations
        ...
        <div className="mx-auto max-w-7xl px-6 space-y-12">
          ...
          <div className="space-y-8 max-w-3xl">
            <p className="text-xl text-muted-foreground leading-relaxed">
              Casal Labs is building toward a world where businesses run on
              intelligent systems that sense, decide, and execute with minimal
              human input.
            </p>
              ...
              <div className="space-y-3">
                <div className="flex items-center gap-4">
                  ...
                  <p className="text-sm text-muted-foreground">
                    Think long-term and value systems over shortcuts
                  </p>
                </div>
                <div className="flex items-center gap-4">
                  <span className="text-blue-800 font-bold text-lg">→</span>
                  <p className="text-sm text-muted-foreground">
                    Want automation that scales with complexity
                  </p>
                </div>
                <div className="flex items-center gap-4">
                  <span className="text-blue-800 font-bold text-lg">→</span>
                  <p className="text-sm text-muted-foreground">
                    Building something serious that compounds over time
                  </p>
                </div>
              </div>
        ...
        <div className="mx-auto max-w-7xl px-6 text-center space-y-8 relative z-10">
          <div className="space-y-4 max-w-3xl mx-auto">
            ...
            <p className="text-xl text-muted-foreground">
              Grow into the next generation of intelligent systems as they
              emerge.
            </p>
          </div>
          ...
          <p className="text-sm text-muted-foreground pt-8 border-t border-border">
            Casal Labs is building applied automation today and quantum-AI
